...
def transform_data():
    raw_data_s3_bucket = "s3://redfin-project-om/raw/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-project-om/transformed/redfin_data.parquet"
