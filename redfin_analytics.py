...
target_s3_bucket_name = "redfin-project-om"
...
def extract_data(**kwargs):
    ...
    file_str = 'redfin_data_' + now_string
...
def transform_data(task_instance):
    ...
    s3_client.put_object(Bucket=target_s3_bucket_name, Key= "transformed/" + object_key, Body=csv_data)
...
with DAG ('redfin_analytics_dag', default_args=default_args, catchup=False) as dag:
    ...
    load_raw_to_s3 = BashOperator(
        ...
        bash_command = 'aws s3 mv {{ ti.xcom_pull("task_extract_redfin_data")[0]}} s3://redfin-project-om/raw/',
    )
